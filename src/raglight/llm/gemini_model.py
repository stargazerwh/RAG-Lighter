...
#                     text="""**Greeting-Based Response**

# I'm focusing on crafting a helpful reply to the user's greeting. The goal is a friendly and relevant response, skipping unnecessary searches for this straightforward task. I'm aiming for concise and appropriate language to ensure a positive interaction.
